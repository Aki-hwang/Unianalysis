...
- 채널 실측 추이: 네이버 70%(7/26) → **80%**(7/28) · Gemini 78% → **83%** · ChatGPT 10% → **10%**(변화 없음) · 웹검색 자동측정 20%
- 네이버 노출·ChatGPT 미노출 키워드가 **14개** — 콘텐츠가 없어서가 아니라 있는 콘텐츠가 ChatGPT까지 닿지 않는 것. 이 격차가 핵심 공략 지점이며 홈페이지 경량화·본문 지역 신호가 1순위인 근거
